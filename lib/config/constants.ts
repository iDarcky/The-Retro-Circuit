...
export const VARIANT_FORM_GROUPS = [
    ...
    },
    {
        ...
        fields: [
            ...
            { label: '2nd OS (dual boot)', key: 'os_secondary_family', type: 'select', required: false, width: 'quarter',
              options: ['android', 'linux', 'steamos', 'windows', 'proprietary', 'other'],
              note: 'Only where it ships dual-boot or the maker supports it. Not community mods.' },
            { label: '2nd OS Version', key: 'os_secondary_version', type: 'text', required: false, width: 'quarter' },
    ...
    },
    {
        ...
        fields: [
            ...
            { label: 'CPU Cores (by cluster)', key: 'cpu_clusters', type: 'custom_cpu_clusters', required: false, subGroup: 'CPU' },
            { label: 'CPU Model (imported text)', key: 'cpu_model', type: 'text', required: false, subGroup: 'CPU',
              note: 'From the spreadsheet import. Do not type here, fill the clusters above.' },
            ...
            { label: 'GPU Clock Min', key: 'gpu_clock_min_mhz', type: 'custom_clock', required: false, subGroup: 'GPU' },
            { label: 'GPU Clock Max', key: 'gpu_clock_mhz', type: 'custom_clock', required: false, subGroup: 'GPU', note: 'Boost clock. Left blank on a fixed-clock part.' },
    ...
    },
    {
        ...
        fields: [
            ...
            { label: 'Base Capacity', key: 'storage_mb', type: 'custom_storage', required: false, width: 'half',
              note: 'MB / GB / TB. Stored as MB so 512 MB and 2 TB both fit.' },
    ...
    },
    {
        ...
        fields: [
            ...
            { label: 'Rumble / Vibration?', key: 'has_rumble', type: 'tribool', required: false, subGroup: 'Extras',
    ...
    },
    {
        ...
        fields: [
            ...
            { label: 'Swappable Battery?', key: 'battery_swappable', type: 'tribool', required: false,
              note: 'Removable pack, as on the Miyoo Mini. Leave Unknown if you have not checked.' },
            ...
            { label: 'Port Position(s)', key: 'charge_port_positions', type: 'multiselect', required: false, subGroup: 'Charging',
              options: ['top', 'bottom', 'left', 'right', 'back'],
              note: 'Pick every position. Several devices charge bottom and have a second port on top.' },
            { label: 'Port Position (legacy)', key: 'charge_port_position', type: 'select', required: false, subGroup: 'Charging', hidden: true,
    ...
    },
    {
        ...
        fields: [
            ...
            { label: 'Jack Position', key: 'headphone_jack_position', type: 'select', required: false, subGroup: 'Speakers',
              options: ['top', 'bottom', 'left', 'right', 'back'] },
            { label: 'Microphone?', key: 'has_microphone', type: 'checkbox', required: false, subGroup: 'Speakers' },

            { subHeader: 'Sensors', column: true },
            { label: 'Gyroscope?', key: 'has_gyro', type: 'tribool', required: false, subGroup: 'Sensors',
