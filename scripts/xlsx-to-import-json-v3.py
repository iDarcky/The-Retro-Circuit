...
SRC='/root/.claude/uploads/f59a1cad-1fd0-5d4f-a900-427f6214ea8d/e7eb3789-handhelds_v3.xlsx'
...
BRAND={'anbernic':'Anbernic','retroid / moorechip':'Retroid','ayaneo':'Ayaneo',
 ...
 '乐天游':'Lotiyo','gamepad digital':'GPD','jinxing digital':'JinXing Digital','powkiddy':'Powkiddy','trimui':'Trimui','miyoo / bittboy':'Miyoo','game kiddy':'Game Kiddy','waveshare':'Waveshare','hardkernel':'HardKernel','clockworkpi':'ClockworkPi','retroflag':'Retroflag','gamepark holdings':'GamePark Holdings','none':'Unknown'}
def brand_of(b):
...
json.dump(out, open('v3_import.json','w'), indent=1, ensure_ascii=False)
