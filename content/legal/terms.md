...
We are **The Retro Circuit** ("we", "us", "our"). We operate the website [theretrocircuit.com](https://theretrocircuit.com) (the "Site"). You can contact us at [contact@theretrocircuit.com](mailto:contact@theretrocircuit.com).
...
You must be at least 13 years old to use the Site. If you are under 18, you must have parental or guardian consent. By using the Site, you confirm that you meet these requirements.

---

## 2. What We Provide

The Retro Circuit is a retro handheld gaming database and comparison tool. We help users discover, compare, and research retro handheld consoles through device listings, spec comparisons, and personalised recommendations. All content is provided for informational purposes only. We do not guarantee that any information on the Site is complete, accurate, or up to date.

---

## 3. Your Account

You may create an account to access certain features of the Site. You are responsible for keeping your login credentials secure and for all activity that occurs under your account. We reserve the right to suspend or terminate accounts that violate these Terms.
...
- Use the Site to advertise or offer to sell goods and services to other users
...
*The Retro Circuit is a participant in the Amazon Associates Programme, an affiliate advertising programme designed to provide a means for sites to earn advertising fees by advertising and linking to Amazon.*
