        ...
        {games.length > 0 && (
            <div className="border-t border-retro-grid p-6 bg-black/20">
                <div className="flex justify-between items-center mb-4">
                    ...
                    <Link href="/archive" className="text-[10px] font-mono text-retro-blue hover:text-white uppercase">See All Games &gt;</Link>
                </div>
                <div className="flex gap-4 overflow-x-auto pb-4 custom-scrollbar snap-x">
                    {games.map(game => (
                        <Link href={`/archive/${game.slug || game.id}`} key={game.id} className="snap-start flex-shrink-0 w-32 group">
