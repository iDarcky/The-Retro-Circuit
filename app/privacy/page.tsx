    ...
    <div className="w-full max-w-3xl mx-auto p-4 py-12 md:py-20 animate-fadeIn">
      ...
      <div className="mb-16 border-b-2 border-dashed border-gray-700 pb-8 relative">
        ...
        <h1 className="text-4xl md:text-6xl font-pixel text-white mb-4 drop-shadow-[4px_4px_0_rgba(255,0,255,0.5)]">
          PRIVACY <br />
          <span className="text-retro-neon">PROTOCOL //</span>
        </h1>
      ...
      <section className="mb-16 relative">
        ...
        <div className="pl-6">
            <p className="font-mono text-lg text-gray-300 leading-relaxed mb-6">
                We utilize <span className="text-retro-neon">Supabase</span> as our primary data storage solution. All data is handled with strict security protocols.
            </p>
      ...
      <section className="mb-16">
        ...
        <div className="bg-black border border-retro-grid p-6 md:p-8 relative overflow-hidden">
            ...
            <div className="absolute top-0 right-0 p-2 opacity-20">
                <svg className="w-16 h-16 text-retro-grid" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1"><path d="M3 3v18h18"/><path d="M18 17V9"/><path d="M13 17V5"/><path d="M8 17v-3"/></svg>
            </div>

            <div className="pl-6 relative z-10">
                <p className="font-mono text-lg text-gray-300 leading-relaxed mb-6">
                    We employ <span className="text-retro-neon">Vercel Analytics</span> for anonymous usage tracking. This helps us understand system performance and user interaction patterns.
                </p>
                <p className="font-mono text-lg text-white leading-relaxed">
        ...
        <div className="flex flex-col md:flex-row gap-8 items-center md:items-start bg-retro-dark/50 border border-dashed border-gray-700 p-8">
            ...
            <div>
                <div className="mb-2">
                    ...
                    <span className="font-mono text-xs text-retro-pink border border-retro-pink px-2 py-0.5">PRIORITY_HIGH</span>
                </div>
