...
export default async function PrivacyPage() {
  ...
  return (
    <div className="bg-bg-primary min-h-screen text-text-primary font-sans selection:bg-sky-500/30 selection:text-text-primary pb-24 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-6 md:px-12 py-16 space-y-16 relative z-10">
          ...
          <section className="grid grid-cols-1 md:grid-cols-[180px_1fr] gap-8">
            ...
            <div className="space-y-6 text-gray-300 leading-relaxed text-lg font-light">
              <p>
                We use <strong className="text-text-primary font-medium">Vercel Analytics</strong> to understand how users interact with our website. This helps us identify performance bottlenecks and improve content relevance.
              </p>
              <div className="bg-sky-500/5 border border-sky-500/20 p-6 md:p-8 relative overflow-hidden group">
                ...
                <p className="text-sm text-gray-400 mb-4 font-mono leading-relaxed">
                  By default, all non-essential cookies and analytics scripts are <strong className="text-text-primary">BLOCKED</strong>. We do not track your activity until you explicitly click &quot;Accept&quot; on our cookie banner.
                </p>
          ...
          <section className="grid grid-cols-1 md:grid-cols-[180px_1fr] gap-8">
            ...
            <div className="space-y-6 text-gray-300 leading-relaxed text-lg font-light">
              <p>
                We utilize <strong className="text-text-primary font-medium">Supabase</strong> as our primary database provider. All data is encrypted at rest and in transit. We do not sell, trade, or otherwise transfer your personally identifiable information to outside parties.
              </p>
            </div>
          </section>
          ...
          <section className="grid grid-cols-1 md:grid-cols-[180px_1fr] gap-8">
            ...
            <div className="space-y-6 text-gray-300 leading-relaxed text-lg font-light">
              <p>
                To protect our infrastructure from abuse, automated attacks, and Denial of Service (DoS) attempts, we utilize <strong className="text-text-primary font-medium">Upstash Redis</strong> for rate limiting on specific API endpoints (such as search and form submissions).
              </p>
              <div className="pl-6 border-l-2 border-sky-500/50">
                  <p className="text-zinc-400 font-light italic">
          ...
          <section className="grid grid-cols-1 md:grid-cols-[180px_1fr] gap-8">
            ...
            <div className="space-y-8 text-gray-300 leading-relaxed text-lg font-light">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                 {/* Card 1 */}
                 <div className="border border-border-subtle bg-bg-tertiary p-6 hover:border-sky-500/30 transition-colors">
                    <h3 className="text-text-primary font-bold uppercase text-xs tracking-widest mb-4 font-mono">Managing Consent</h3>
                 ...
                 {/* Card 2 */}
                 <a href="mailto:contact@theretrocircuit.com" className="border border-border-subtle bg-bg-tertiary p-6 hover:border-sky-500/30 transition-colors block group">
                    <h3 className="text-text-primary group-hover:text-sky-400 transition-colors font-bold uppercase text-xs tracking-widest mb-4 font-mono">Contact Us</h3>
