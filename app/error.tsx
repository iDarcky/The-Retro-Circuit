...
export default function Error({
  ...
  // Only surface raw exception text in development — in production it can leak internal detail.
  ...
  return (
    <div
      role="alert"
      aria-live="assertive"
      className="fixed inset-0 bg-[#0000AA] text-white font-mono p-8 flex flex-col items-center justify-center text-center z-[100] overflow-y-auto"
    >
      ...
      <div className="text-left border-2 border-white p-4 mb-8 max-w-2xl bg-[#000088] w-full">
         ...
         {isDev ? (
           ...
           <p className="font-mono text-sm">An unexpected error occurred. Our team has been notified.</p>
         )}
         {error.digest && <p className="mt-2 text-xs text-gray-200">Reference: {error.digest}</p>}
      </div>
