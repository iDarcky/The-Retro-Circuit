...
/* /consoles/vendor/<value>. A static segment, not a dynamic one: `app/consoles/[slug]`
...
export async function generateMetadata(props: Props): Promise<Metadata> {
    ...
    return facetMetadata('vendor', value);
}

export default async function Page(props: Props) {
    const { value } = await props.params;
    return <FacetLanding facetSlug="vendor" value={value} />;
}
