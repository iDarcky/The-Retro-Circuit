    ...
    <div className="min-h-screen bg-bg-primary text-text-primary p-8 font-sans">
      <div className="max-w-6xl mx-auto space-y-16">
        ...
        <section className="space-y-8">
          ...
          <div className="grid gap-8 bg-bg-tertiary p-8 border border-border-normal">
            <div>
            ...
            <div className="pt-8 border-t border-border-normal">
        ...
        <section className="space-y-8">
          ...
          <div className="grid grid-cols-1 gap-8">
            ...
            <div className="bg-bg-tertiary p-8 border border-border-normal space-y-6">
        ...
        <section className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-bg-tertiary p-8 border border-violet-500/50 space-y-6 relative overflow-hidden group hover:border-violet-500 transition-colors">
              <div className="absolute top-0 right-0 bg-violet-500 text-bg-primary text-[10px] font-mono px-2 py-1 font-bold">PROPOSAL</div>
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <div className="inline-flex items-center text-[10px] font-sans font-bold uppercase tracking-widest border border-border-strong text-bg-primary bg-text-primary">
                ...
                <div className="inline-flex items-center text-[10px] font-sans font-bold uppercase tracking-widest border border-orange-500 text-bg-primary bg-orange-500">
        ...
        <section className="space-y-8 mt-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* Forms & Inputs */}
            <div className="bg-bg-tertiary p-8 border border-border-normal space-y-8 relative overflow-hidden group hover:border-border-strong/30 transition-colors">
              <div className="absolute top-0 right-0 bg-text-primary text-bg-primary text-[10px] font-mono px-2 py-1 font-bold">PROPOSAL 01</div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-1 mt-6">
                  ...
                  <div className="relative group/input">
                    <input type="text" placeholder="Input specific criteria..." className="w-full bg-transparent border-2 border-border-normal p-3 text-sm font-mono text-text-primary placeholder:text-zinc-600 focus:outline-none focus:border-violet-500 focus:bg-bg-tertiary transition-colors rounded-none" />
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Stepper */}
            <div className="bg-bg-tertiary p-8 border border-border-normal space-y-8 relative overflow-hidden hover:border-border-strong/30 transition-colors">
              <div className="absolute top-0 right-0 bg-text-primary text-bg-primary text-[10px] font-mono px-2 py-1 font-bold">PROPOSAL 02</div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-1 mt-6">
                  ...
                  <div className="inline-flex">
                    <button className="w-10 h-10 bg-bg-tertiary border border-border-normal text-text-primary hover:bg-text-primary hover:text-bg-primary transition-colors flex items-center justify-center font-sans font-bold text-lg">-</button>
            ...
            {/* Toggles */}
            <div className="bg-bg-tertiary p-8 border border-border-normal space-y-8 relative overflow-hidden hover:border-border-strong/30 transition-colors">
              <div className="absolute top-0 right-0 bg-text-primary text-bg-primary text-[10px] font-mono px-2 py-1 font-bold">PROPOSAL 03</div>
              <h3 className="text-xl font-pixel text-text-primary mb-6">Checkboxes & Toggles</h3>

              <div className="space-y-4">
                <div className="flex items-center gap-2 border-b border-border-normal pb-4">
                ...
                <div className="space-y-4 mt-6">
                  ...
                  <div className="flex items-center gap-4 cursor-pointer group/cb">
                    <div className="w-5 h-5 border-2 border-border-strong/30 flex items-center justify-center group-hover/cb:border-border-strong transition-colors">
                    </div>
                  ...
                  {/* Swiss Toggle */}
                  <div className="flex items-center gap-4 mt-6 pt-6 border-t border-border-normal">
            ...
            {/* Breadcrumbs */}
            <div className="bg-bg-tertiary p-8 border border-border-normal space-y-8 relative overflow-hidden hover:border-border-strong/30 transition-colors">
              <div className="absolute top-0 right-0 bg-text-primary text-bg-primary text-[10px] font-mono px-2 py-1 font-bold">PROPOSAL 04</div>
              ...
              <div className="space-y-4 mt-6">
                <div className="flex items-center text-xs font-mono tracking-wider">
                  <span className="text-text-muted hover:text-text-primary cursor-pointer transition-colors bg-bg-tertiary px-2 py-1 border border-border-normal">Systems</span>
                  <div className="w-4 h-px bg-text-primary/20 mx-2"></div>
                  <span className="text-text-muted hover:text-text-primary cursor-pointer transition-colors bg-bg-tertiary px-2 py-1 border border-border-normal">Handhelds</span>
                  <div className="w-4 h-px bg-text-primary/20 mx-2"></div>
                  <span className="text-bg-primary bg-text-primary px-2 py-1 border border-border-strong font-bold">Analogue Pocket</span>
                </div>
              </div>
            </div>
            ...
            {/* Toggles V2 */}
            <div className="bg-bg-tertiary p-8 border border-border-normal space-y-8 relative overflow-hidden hover:border-border-strong/30 transition-colors">
              <div className="absolute top-0 right-0 bg-text-primary text-bg-primary text-[10px] font-mono px-2 py-1 font-bold">PROPOSAL 03_V2</div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-4 mt-6">
                  ...
                  <div className="flex items-center gap-4 cursor-pointer group/cb2">
                    <div className="w-5 h-5 border border-border-strong/30 flex items-center justify-center bg-transparent group-hover/cb2:border-border-strong transition-colors p-0.5">
                  ...
                  <div className="flex items-center gap-4 cursor-pointer group/cb2">
                    <div className="w-5 h-5 border border-border-strong/30 flex items-center justify-center group-hover/cb2:border-border-strong transition-colors p-0.5">
                    </div>
                  ...
                  {/* Swiss Toggle V2 */}
                  <div className="flex items-center gap-4 mt-6 pt-6 border-t border-border-normal">
                    <div className="w-12 h-5 bg-text-primary/10 flex items-center cursor-pointer relative overflow-hidden">
            ...
            {/* Breadcrumbs V2 */}
            <div className="bg-bg-tertiary p-8 border border-border-normal space-y-8 relative overflow-hidden hover:border-border-strong/30 transition-colors">
              <div className="absolute top-0 right-0 bg-text-primary text-bg-primary text-[10px] font-mono px-2 py-1 font-bold">PROPOSAL 04_V2</div>
              <h3 className="text-xl font-pixel text-text-primary mb-6">Navigation Paths (V2)</h3>

              <div className="space-y-4 mt-6">
                <div className="flex items-center text-xs font-mono tracking-wider">
                  <span className="text-text-secondary hover:text-text-primary cursor-pointer transition-colors pb-1">SYSTEMS</span>
                  <span className="text-border-normal mx-3 font-mono">//</span>
                  <span className="text-text-secondary hover:text-text-primary cursor-pointer transition-colors pb-1">HANDHELDS</span>
                  <span className="text-border-normal mx-3 font-mono">//</span>
            ...
            {/* Expandables */}
            <div className="bg-bg-tertiary p-8 border border-border-normal space-y-8 relative overflow-hidden col-span-1 md:col-span-2 hover:border-border-strong/30 transition-colors">
              <div className="absolute top-0 right-0 bg-text-primary text-bg-primary text-[10px] font-mono px-2 py-1 font-bold">PROPOSAL 05</div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div className="space-y-0 border-t-4 border-violet-500">
                  <div className="flex items-center justify-between p-4 cursor-pointer bg-bg-tertiary hover:bg-text-primary/10 transition-colors border-b border-border-normal">
                  ...
                  <div className="flex items-start justify-between p-4 cursor-pointer bg-text-primary/[0.02] border-b border-border-normal">
                    <div className="space-y-4 w-full">
                      ...
                      <div className="font-mono text-xs text-text-secondary space-y-2 pb-2 pl-4 border-l-2 border-border-normal">
                ...
                <div className="space-y-6">
                  ...
                  <div className="pt-4 border-t border-border-normal">
                    <label className="text-[10px] text-text-secondary font-mono tracking-widest uppercase block mb-2">Alert / Toast Panel</label>
                    <div className="bg-orange-500 text-bg-primary p-4 border-l-8 border-black flex gap-4 items-start">
            ...
            <div className="bg-transparent p-0 border-none space-y-8 relative overflow-hidden col-span-1 md:col-span-2">
               ...
               <div className="grid grid-cols-3 gap-0 border border-border-normal bg-bg-primary">
                 <div className="border-r border-b border-border-normal p-8 flex flex-col items-center justify-center min-h-[160px] bg-bg-tertiary">
                    <div className="w-16 h-16 bg-text-primary flex items-center justify-center mb-4">
                      <span className="font-mono text-xl text-bg-primary font-bold">M</span>
                    </div>
                 ...
                 <div className="border-r border-b border-border-normal p-8 flex flex-col justify-center">
                   <div className="space-y-4 font-mono text-sm">
                     <div className="flex justify-between border-b border-border-normal pb-2">
