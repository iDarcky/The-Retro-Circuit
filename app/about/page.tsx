...
export default function AboutPage() {
  return (
    <div className="w-full max-w-3xl mx-auto p-4 py-12 md:py-20 animate-fadeIn">
      ...
      <section className="mb-16 relative">
        ...
        <div className="pl-6">
            ...
            <p className="font-mono text-lg text-white leading-relaxed">
                ...
                <span className="text-retro-neon bg-retro-neon/10 px-1">No feelings. Just data.</span>
            </p>
        </div>
      </section>
      ...
      <section className="mb-16">
        ...
        <div className="bg-black border border-retro-grid p-6 md:p-8 relative overflow-hidden">
            ...
            <div className="absolute top-0 right-0 p-2 opacity-20">
                <svg className="w-16 h-16 text-retro-grid" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1"><circle cx="12" cy="12" r="10"/><path d="M2 12h20"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-y-4 gap-x-12 font-mono text-sm relative z-10">
                <div className="flex justify-between border-b border-gray-800 pb-2">
                    ...
                    <span className="text-retro-neon">NEXT.JS 14 (APP ROUTER)</span>
                </div>
                <div className="flex justify-between border-b border-gray-800 pb-2">
                    <span className="text-gray-500">DATA_LAYER</span>
                    <span className="text-retro-neon">SUPABASE (POSTGRESQL)</span>
                </div>
                <div className="flex justify-between border-b border-gray-800 pb-2">
                    <span className="text-gray-500">UI_ENGINE</span>
                    <span className="text-retro-neon">TAILWIND CSS</span>
                </div>
                <div className="flex justify-between border-b border-gray-800 pb-2">
                    <span className="text-gray-500">DEPLOYMENT</span>
                    <span className="text-retro-neon">VERCEL EDGE</span>
                </div>
                <div className="flex justify-between border-b border-gray-800 pb-2">
                    <span className="text-gray-500">SECURITY</span>
                    <span className="text-retro-neon">ROW LEVEL SECURITY</span>
                </div>
                <div className="flex justify-between border-b border-gray-800 pb-2">
                    <span className="text-gray-500">TYPE_SAFETY</span>
                    <span className="text-retro-neon">TYPESCRIPT (STRICT)</span>
                </div>
            </div>
        </div>
      </section>
      ...
      {/* ACTIONS */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 border-t-2 border-retro-grid pt-12">
        <a href={siteConfig.links.email} className="w-full">
            <Button variant="secondary" className="w-full flex justify-center border-retro-neon text-retro-neon hover:bg-retro-neon hover:text-black">
                [ OPEN COMMS ]
            </Button>
        </a>
        ...
        <a href={siteConfig.links.linkedin} target="_blank" rel="noopener noreferrer" className="w-full">
            <Button variant="secondary" className="w-full flex justify-center border-retro-blue text-retro-blue hover:bg-retro-blue hover:text-black">
                LINKEDIN LINK
            </Button>
        </a>
      </div>
