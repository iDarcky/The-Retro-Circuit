  ...
  return (
    <div className="min-h-screen bg-bg-primary text-text-primary px-6 py-12 md:py-24">
      <div className="max-w-4xl mx-auto">
        {/* Hero Section */}
        <div className="mb-16">
          <div className="inline-flex items-center gap-2 px-2 py-0.5 rounded-full border border-violet-900/30 bg-violet-950/10 text-[10px] md:text-xs font-mono uppercase tracking-widest text-violet-400 mb-6 animate-fade-in backdrop-blur-sm shadow-[0_0_15px_-3px_rgba(139,92,246,0.1)]">
             <div className="w-1.5 h-1.5 bg-violet-500 rounded-full animate-pulse shadow-[0_0_8px_rgba(139,92,246,0.5)]"></div>
             System Update // v1.0
          </div>
          ...
          <p className="text-lg md:text-xl text-text-secondary font-light max-w-2xl leading-relaxed">
             ...
             Here is our 40-day mission plan to launch Version 1.0.
          </p>
        </div>
