        ...
        <div className="w-full relative">
            ...
            <div className="flex border-b border-white/10 mb-8">
                <button
                    ...
                    className={`px-6 py-3 text-sm font-mono uppercase tracking-widest border-b-2 transition-all duration-300 ${activeTab === 'upcoming'
                ...
                <button
                    ...
                    className={`px-6 py-3 text-sm font-mono uppercase tracking-widest border-b-2 transition-all duration-300 ${activeTab === 'changelog'
