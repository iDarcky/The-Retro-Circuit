                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-12 items-center">
                    ...
                    <div className="flex justify-start md:justify-end w-full">
                        <div className="relative group w-full md:w-auto">
                            ...
                            <Link
                                href="/finder"
                                className="relative z-10 inline-flex items-center gap-3 bg-cyan-600 text-white font-mono text-xs md:text-sm px-6 py-3 hover:brightness-110 transition-all uppercase tracking-widest border border-cyan-500 shadow-lg shadow-cyan-500/20 w-full md:w-auto justify-center"
                            >
