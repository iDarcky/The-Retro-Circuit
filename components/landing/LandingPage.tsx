  ...
  return (
    <div className="min-h-screen bg-retro-dark text-retro-neon font-mono selection:bg-retro-pink selection:text-white border-[16px] border-retro-dark overflow-x-hidden flex flex-col">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 flex-1 border-l-2 border-retro-grid min-h-[calc(100vh-200px)]">
        ...
        {/* Left Column (Hero / Database) - 8/12 columns */}
        <div className="col-span-1 md:col-span-8 p-8 md:p-12 flex flex-col justify-between border-r-2 border-retro-grid bg-retro-dark relative">
            <div className="absolute top-4 right-4 text-xs text-gray-500">
                EST. 2024<br/>ARCHIVE_V1.0
            </div>

            <div className="mt-12">
                <h1 className="text-7xl md:text-[8rem] font-black text-white leading-[0.85] tracking-tighter mix-blend-difference mb-8">
                    DATA<br/>
                    BASE
                </h1>
            ...
            <div className="flex flex-col gap-6 mt-16 md:mt-32">
        ...
        {/* Right Column (Menu Stack) - 4/12 columns */}
        <div className="col-span-1 md:col-span-4 flex flex-col">

            {/* Block 1: VS MODE (Neon Orange/Red vibe -> Retro Neon for now) */}
            <Link href="/arena" className="flex-1 bg-retro-neon text-black p-8 border-b-2 border-black flex flex-col justify-between hover:bg-white transition-colors group relative overflow-hidden">
            ...
            {/* Block 2: NEWS (Retro Blue) */}
            <Link href="/news" className="flex-1 bg-retro-blue text-black p-8 border-b-2 border-black flex flex-col justify-between hover:bg-white transition-colors group relative overflow-hidden">
                <div className="flex justify-between items-start z-10">
            ...
            {/* Block 3: JOIN (Black) */}
            <Link href="/login" className="flex-[1.5] bg-black text-white p-8 flex flex-col justify-center items-center hover:bg-retro-pink hover:text-black transition-colors group text-center">
