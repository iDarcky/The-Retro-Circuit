...
export default function FabricatorDetailClient({ profile, consoles }: Props) {
    ...
    return (
        <div className="w-full min-h-screen bg-bg-primary text-text-primary pb-32 animate-[fadeIn_0.5s_ease-in-out]" style={cssVars}>
            ...
            <div className="max-w-[1800px] mx-auto p-6 md:p-12">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-12 items-start">
                    ...
                    <div className="lg:col-span-4 flex flex-col gap-6 lg:sticky lg:top-24">
                         ...
                         {/* Logo Container */}
                         <div className="w-full aspect-video bg-bg-primary/40 border-t border-b border-[var(--brand-color)] flex items-center justify-center p-8 relative overflow-hidden group shadow-[0_0_30px_rgba(0,0,0,0.5)]">
                             ...
                             {profile.image_url ? (
                                ...
                                <span className="font-pixel text-4xl text-border-normal">?</span>
                             )}
                         </div>
                         ...
                         {profile.website && (
                            <a
                                ...
                                target="_blank"
                                className="w-full py-4 bg-bg-tertiary border border-border-subtle text-zinc-300 font-mono text-xs uppercase hover:bg-[var(--brand-color)] hover:text-black hover:border-[var(--brand-color)] transition-all flex items-center justify-between px-6 group"
                            >
                    ...
                    <div className="lg:col-span-8 flex flex-col justify-start gap-8 lg:pt-4">
                        <div className="relative">
                            ...
                            <h2 className="text-3xl md:text-5xl font-pixel text-text-primary leading-tight uppercase mb-8 tracking-tight">
            ...
            {/* --- CONTROLS BAR (Sticky) --- */}
            <div className="sticky top-0 z-50 bg-bg-primary/80 backdrop-blur-xl border-y border-border-subtle px-6 md:px-12 py-4">
            ...
            {/* --- EXPANDABLE FILTERS --- */}
            <div className={`w-full bg-bg-primary/40 backdrop-blur-md border-b border-border-subtle p-4 transition-all duration-300 ${showFilters ? 'block' : 'hidden'}`}>
                <div className="max-w-[1800px] mx-auto flex flex-col md:flex-row gap-6 items-start md:items-center justify-between flex-wrap">
                  ...
                  <div className="flex flex-col gap-2">
                        ...
                        <div className="flex gap-2 items-center">
                                <input
                                type="number"
                                className="bg-transparent border-b border-border-normal text-text-primary font-mono text-xs py-1 w-16 text-center focus:border-[var(--brand-color)] outline-none"
                ...
                {paginatedConsoles.length === 0 ? (
                    <div className="flex flex-col items-center justify-center py-32 border border-dashed border-border-subtle rounded-xl bg-bg-tertiary">
                        ...
                        <button onClick={() => setFilters({
                            ...
                            panel_types: [],
                            manufacturer_id: null
                        })} className="mt-4 text-[var(--brand-color)] hover:text-text-primary text-xs font-mono uppercase underline">
                            Reset Parameters
                        </button>
                    </div>
                ) : (
                            ...
                            if (viewMode === 'swiss') {
                                ...
                                return (
                                    <Link
                                        ...
                                        key={console.id}
                                        className="group relative flex flex-col bg-bg-tertiary hover:bg-white/[0.04] border border-border-strong/5 hover:border-[var(--brand-color)] transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-[0_0_15px_rgba(var(--brand-rgb),0.1)] rounded-xl overflow-hidden"
                                    >
                                        ...
                                        <div className="p-4 border-t border-border-strong/5 bg-bg-secondary">
                                            ...
                                            <h3 className="text-sm font-bold text-text-primary leading-tight group-hover:text-[var(--brand-color)] transition-colors truncate">
                                                {console.name}
                                            </h3>
                                        </div>
                                    </Link>
                                ...
                                return (
                                    <Link
                                        href={`/consoles/${console.slug}`}
                                        key={console.id}
                                        className="group block bg-bg-primary border border-zinc-800 hover:border-[var(--brand-color)] transition-all relative overflow-hidden"
                                    >
                                        <div className="flex flex-row h-32">
                                            ...
                                            <div className="w-2/3 p-4 flex flex-col justify-between">
                                                <div>
                                                    ...
                                                    <h3 className="font-bold text-lg text-text-primary group-hover:text-[var(--brand-color)] mt-1">{console.name}</h3>
                                                </div>
