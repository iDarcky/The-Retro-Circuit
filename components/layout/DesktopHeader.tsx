      ...
      <nav className="hidden md:flex h-16 items-stretch divide-x divide-border-subtle">
          ...
          <div className="flex shrink-0 bg-bg-primary hover:bg-bg-secondary transition-colors duration-300">
              <Link href="/" className="flex items-center px-6 group h-full w-full">
                  <span className="font-pixel text-[14px] leading-tight text-border-normal group-hover:text-secondary transition-colors">RETRO CIRCUIT_</span>
              </Link>
          </div>
          ...
          <div className="flex-1 flex items-center justify-center bg-bg-primary">
              <button
                  onClick={openSearch}
                  className="w-96 flex items-center justify-between border border-border-normal bg-bg-secondary/50 px-4 py-2 font-bold text-gray-400 hover:text-text-primary hover:border-violet-500/50 hover:bg-bg-secondary transition-all group"
              >
                  ...
                  <div className="flex gap-1">
                      <span className="text-[10px] bg-bg-primary border border-border-subtle px-1.5 py-0.5 text-gray-500 font-mono group-hover:border-violet-500/30 group-hover:text-violet-400 transition-colors">CMD</span>
                      <span className="text-[10px] bg-bg-primary border border-border-subtle px-1.5 py-0.5 text-gray-500 font-mono group-hover:border-violet-500/30 group-hover:text-violet-400 transition-colors">K</span>
                  </div>
              </button>
          </div>
                  ...
                  return (
                      <Link
                          ...
                          className={`group relative uppercase font-pixel text-[10px] py-1 transition-colors ${
                              isActive ? 'text-text-primary' : 'text-gray-500 hover:text-text-primary'
                          }`}
                      >
                          {item.name}
                          <span
