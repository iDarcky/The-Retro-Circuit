...
export default function AppShell({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    // Scroll to top handled by Next.js automatically on navigation usually, but kept for safety
