             ...
             <div className="w-full max-w-[1600px] mx-auto px-4 md:px-8 py-12">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-12">
                    ...
                    <div className="lg:col-span-4 space-y-6">
                        ...
                        {/* Analysis / Description (Jump Target) */}
                        ...
                        {/* EMULATION PERFORMANCE GRID (Jump Target) */}
                        <div id="playability">
                    ...
                    <div id="tech" className="lg:col-span-8">
                        ...
                        <div id="buy" className="mt-8 border border-white/10 p-8 flex items-center justify-center bg-white/5">
