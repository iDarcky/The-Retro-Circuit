    ...
    return (
        <div className="border border-border-subtle p-6 bg-bg-secondary">
            ...
            <div className="font-mono text-xs text-gray-500 space-y-3">
                <div className="flex justify-between items-center border-b border-border-strong/5 pb-2">
                    <span className="tracking-wider">STATUS</span>
                    <span className="text-text-primary bg-border-subtle px-2 py-0.5 text-[10px]">CLASSIFIED</span>
                </div>
                <div className="flex justify-between items-center border-b border-border-strong/5 pb-2">
