        ...
        <div className="space-y-6">
            ...
            <div className="border-2 border-retro-blue bg-retro-blue/5 p-6">
                ...
                <div className="grid gap-4">
                    ...
                    <Link to="/sage" className="block">
                        <div className="group border-2 border-retro-grid hover:border-yellow-400 bg-black p-4 flex items-center justify-between transition-all">
                            <div>
                                <div className="font-pixel text-sm text-white group-hover:text-yellow-400">THE ORACLE</div>
                                <div className="font-mono text-xs text-gray-500">AI Chat Assistant</div>
                            </div>
